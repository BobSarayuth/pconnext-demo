...
FAQ_ENTRIES: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "answer": (
            "ในโปรเจกต์นี้ P Connext คือระบบ demo สำหรับผู้ช่วยสนทนาที่ช่วยตอบคำถามและค้นหาข้อมูลสินค้า/บริการ "
            "โดยเชื่อมกับการค้นหา SKU, profile สินค้า, FAQ และการส่งต่อเจ้าหน้าที่เมื่อจำเป็น "
    ...
    },
    {
        ...
        "answer": (
            ...
            "ระบบยังไม่รองรับการตอบราคา ใบเสนอราคา หรือการสั่งซื้อ"
        ),
